...
def _add_common_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    memrl_group = parser.add_mutually_exclusive_group()
    memrl_group.add_argument(
        "--memrl-use-memory",
        "--memrl_use_memory",
        dest="memrl_use_memory",
        action="store_true",
        default=None,
        help="Enable MemRL memory retrieval/reference for memrl_knowu agents.",
    )
    memrl_group.add_argument(
        "--no-memrl-use-memory",
        "--no_memrl_use_memory",
